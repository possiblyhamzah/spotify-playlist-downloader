...
class Playlist(object):
    ...
    def __init__(self, download_url, working_dir, folder_name, audio_codec='flac', audio_bitrate=1141, playlist_start=1, playlist_end=0, clear_cache=False, verbose=False, test_id=None):
        """
        Initializer
